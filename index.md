...
<head>
  ...
  <style>
    :root { --ink: #e7f7f5; --muted: #91aaa9; --paper: #080c12; --line: #233640; --accent: #00f0ff; --pink: #ff3cac; --serif: Georgia, "Times New Roman", serif; --sans: "Trebuchet MS", "Segoe UI", sans-serif; }
    * { box-sizing: border-box; }
    body { margin: 0; color: var(--ink); background: radial-gradient(circle at 80% 15%, #142238 0, transparent 30%), var(--paper); font-family: var(--sans); line-height: 1.6; }
    a { color: inherit; }
    .header { border-bottom: 1px solid var(--line); background: rgba(8, 12, 18, .9); }
    ...
    .eyebrow { color: var(--pink); font-size: .78rem; font-weight: bold; letter-spacing: .14em; text-transform: uppercase; }
...
<body>
  <header class="header">
    <nav class="nav" aria-label="Main navigation">
      ...
      <div class="nav-links"><a href="{{ '/' | relative_url }}">Home</a><a href="{{ '/projects/' | relative_url }}">Projects</a><a href="{{ '/goals/' | relative_url }}">Goals</a><a href="{{ '/socials/' | relative_url }}">Socials</a></div>
    </nav>
  </header>
  <main class="main">
    <section class="intro">
